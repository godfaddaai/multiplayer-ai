...
Current evidence score: **76/100** after the public 0.4.11 deployment,
...
| Criterion | Points | Current evidence |
|---|---:|---|
| Versioned GitHub release and one-command Homebrew install | 4/4 | 0.4.11 public asset hash plus isolated install verified; CI run 30800846625 proves the Node 22 Homebrew formula installs, executes 0.4.11, tests, uninstalls, and leaves both CLI links absent on clean macOS 26 and Linux |
| Host setup installs and verifies a reachable matching service | 4/4 | Matching-version 0.4.11 doctor receipts on the live Reagan and Hudson hosts; one session-scoped invite command now atomically creates the invite and ready room |
...
| Real service restart and matching-version health | 2/2 | Live Reagan and Hudson 0.4.11 public-asset installs, service restarts, matching doctor receipts, reciprocal session reads, and Hudson's managed-provider restart with post-turn health |
...
1. **Closed:** Homebrew 0.4.11 installs, executes, tests, and uninstalls on clean
